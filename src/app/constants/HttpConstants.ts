export class HttpConstants {
    ...
    static readonly HEURISTIC_EXPIRATION = 113;
    static readonly MISCELLANEOUS_WARNING = 199;
    ...
    static readonly TRANSFORMATION_APPLIED = 214;
    static readonly IM_USED = 226;
    static readonly MISCELLANEOUS_PERSISTENT_WARNING = 299;
    ...
    static readonly TOO_MANY_REDIRECTS = 310;
